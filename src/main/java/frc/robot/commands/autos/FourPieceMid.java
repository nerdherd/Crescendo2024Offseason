...
//                     // note 2
//                     Commands.deadline(
//                         Commands.waitSeconds(0.4).andThen(Commands.waitUntil(() -> superSystem.intakeBeamBreak.noteSensed())),
//                         superSystem.shootSpeaker()
//                     )
//                     // Commands.race(
...
//                     superSystem.intakeUntilSensed(),
//                     Commands.waitUntil(() -> superSystem.intakeBasic()))
//                 ),
...
//                         Commands.deadline(
//                             Commands.waitUntil(() -> superSystem.intakeBasic())).andThen(Commands.waitSeconds(0.1)),
//                             superSystem.shootSpeaker()
//                         ),
